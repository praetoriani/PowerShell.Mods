#
# Module manifest for module 'httphost.local'
#
...
RootModule = 'httphost.local.psm1'
...
Description = @'
httphost.local is a Standalone PowerShell Module that provides a local HTTP Server
