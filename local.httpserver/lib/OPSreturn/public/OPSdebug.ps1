function OPSdebug {
    <#
    .SYNOPSIS
        Shorthand for OPSreturn -Code debug.
    .EXAMPLE
        return OPSdebug  "Debug Message" -Exception $_.Exception
    #>
    [CmdletBinding()]
    ...
    return OPSreturn -Code ([OPScode]::debug) -Message $Message -Exception $Exception -Data $Data
}
